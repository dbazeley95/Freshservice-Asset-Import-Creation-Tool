...
import { ASSET_TYPES, ASSET_STATE_SUGGESTIONS, defaultColumns, generalColumns, hardwareColumns, extraRowColumns } from './templates.js?v=2.4.0';
import { buildCsv, downloadCsv } from './csv.js?v=2.4.0';
import { loadState, saveState, clearState, loadSuggestions, addSuggestion } from './storage.js?v=2.4.0';
import { SITE_PRESETS, LOCATIONS_BY_COMPANY, MODEL_PRESETS } from './catalog.js?v=2.4.0';
import { iconSvg } from './icons.js?v=2.4.0';
