...
import { ASSET_TYPES, ASSET_STATE_SUGGESTIONS, defaultColumns, generalColumns, hardwareColumns, extraRowColumns } from './templates.js?v=1.8.1';
import { buildCsv, downloadCsv } from './csv.js?v=1.8.1';
import { loadState, saveState, clearState, loadSuggestions, addSuggestion } from './storage.js?v=1.8.1';
import { SITE_PRESETS, LOCATIONS_BY_COMPANY, MODEL_PRESETS } from './catalog.js?v=1.8.1';
import { iconSvg } from './icons.js?v=1.8.1';
